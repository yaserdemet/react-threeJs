...
export default function WeatherCard({ data }) {
  const { iconUrl, main, title, weather, name, sys } = data;
    ...
    <Card sx={{ maxWidth: 345 }} className="cardt">
      ...
      <CardContent>
        <Typography variant="body2" color="text.secondary">
          ...
          <strong style={{color : temp(Math.round(main.temp))}}   >{Math.round(main.temp)}</strong>
        </Typography>
        <Button onClick={() => setClick(!click)}>
              {
        ...
        </Button>
                {
                  ...
                  <ul>
                    ...
                    <li>Description : {capitalizeWords( (weather[0].description))}
                    </li>
                  </ul>
                }
